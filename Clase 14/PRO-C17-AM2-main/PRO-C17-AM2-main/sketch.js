...
function preload(){
  ...
  volando = loadAnimation("pajarito.png","pajarito2.png","pajarito.png")
  estrellado = loadAnimation("pajarito.png","pajarito.png","pajarito.png")
...
function setup(){
 ...
 dinosaurio.addImage("choco",dino2)
...
if(pajaritosmax.isTouching(dinosaurio)){
  gameState = "gameOver"
  superFinal.visible = true
  volver.visible = true
...
pajaros.changeAnimation("morir",estrellado)
pajaritosmax.setVelocityXEach(0)
...
if(frameCount%500 === 0){
   pajaros = createSprite(1000,150,20,20)
  pajaros.addAnimation("pajaro volando mucho",volando)
  pajaros.addAnimation("morir",estrellado)
  pajaros.velocityX = -(5+2*marcador/500)
  pajaros.scale = 0.5
  pajaritosmax.add(pajaros)
}
